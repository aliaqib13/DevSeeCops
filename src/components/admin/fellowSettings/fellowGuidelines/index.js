...
export default class FellowGuidelines extends Component {
    constructor(props) {
        super(props);
        this.state = {
            steps: [],
    ...
    componentDidMount() {
        const loader = message.loading('load guidelines');
        this.props.getFellowGuideLines().then(res => {
            if (res.status === 200) {
                this.setState({
    ...
    save = () => {
        ...
        this.props.updateFellowGuidelines({
            content: steps,
        }).then(res => {
            if (res.status === 200) {
                this.setState({
    ...
    render() {
        ...
        return (
            <div className="fellow-guidelines-container">
                <Title className="fellow-guidelines-title" level={4}> Fellow Guidelines</Title>
