...
class Help extends Component {
    ...
    componentDidMount() {
        const loader = message.loading('load help');
        this.props.getHelp().then(res => {
            if (res.status === 200) {
                this.setState({
    ...
    render() {
        ...
        return (
            <div className="help-container">
                <Title className="help-title" level={4}> Help </Title>

                <div className="help-list">
                    <Row>
                        <Col offset={11} span={13}>
                            <div className="save-help-container">
                                <Button
                                    className="btn-save-help"
                                    onClick={this.save}
                                    type="primary"
                                >
                                    Save
