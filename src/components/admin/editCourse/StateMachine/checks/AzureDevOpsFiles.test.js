...
import AzureDevOpsFiles from './AzureDevOpsFiles';
...
describe('AzureDevOpsFiles', () => {
    let component;
    beforeEach(() => {
        component = shallow(<AzureDevOpsFiles {...props} />);
    });
    ...
    it('Should render heading and arrows', () => {
        ...
        expect(headingAndArrows.props.children[0].props.children).toBe('Azure DevOps Files');
    ...
    it('Should set new props and thus call UNSAFE_componentWillReceiveProps to update the state', () => {
        const receiveProps = jest.spyOn(AzureDevOpsFiles.prototype, 'UNSAFE_componentWillReceiveProps');
