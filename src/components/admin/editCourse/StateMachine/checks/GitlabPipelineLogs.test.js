...
import GitlabPipelineLogs from './GitlabPipelineLogs';
...
describe('GitlabPipelineLogs', () => {
    let component;
    beforeEach(() => {
        component = shallow(<GitlabPipelineLogs {...props} />);
    });
    ...
    it('Should render heading and arrows', () => {
        ...
        expect(headingAndArrows.props.children[0].props.children).toBe('GitLab Pipeline Logs');
    ...
    it('Should set new props and thus call UNSAFE_componentWillReceiveProps to update the state', () => {
        const receiveProps = jest.spyOn(GitlabPipelineLogs.prototype, 'UNSAFE_componentWillReceiveProps');
