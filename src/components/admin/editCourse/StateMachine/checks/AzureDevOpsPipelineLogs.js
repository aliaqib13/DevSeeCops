...
class AzureDevOpsPipelineLogs extends Component {
    constructor(props) {
        super(props);
        const {
            contentMissing, contentExists, valueMissing, valuePresent, event,
        } = props.item;
        this.state = {
            contentMissing,
            contentExists,
            ...
            <div className="state-block" key={index}>
                ...
                <div style={{ width: '80%' }}>
                    ...
                    <div className="config-block">
                        <span>Azure DevOps Pipeline Logs</span>
...
export default AzureDevOpsPipelineLogs;
