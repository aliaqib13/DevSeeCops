            ...
            <>
                <div id="category">
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-8" id="dennis-animation3">
                                <h2
                                ...
                                <div style={{ position: 'relative' }}>
                                    ...
                                    <div className="description_block" id='description_block'>
                                        ...
                                        <Link to="/sarah">{this.state.link}</Link>
                                    </div>
                                </div>
                                <p style={{ fontFamily: "'Montserrat', sans-serif", marginTop: '50px' }}>
                                    <span
                                        style={{ color: '#000000', fontSize: '16px' }}
                                    >
                                        Categories and Learning Paths are created to help you define your preferences and priorities.
                                    </span>
                                    <br />
                                    <span style={{ color: '#000000', fontSize: '16px' }}> This structure is based on our community of Fellows and other experts in the DevSecOps domain's input.​</span>
                                </p>
                            </div>
                            <div className="col-lg-4" id="dennis-animation4">
                                <p>
                                    <em>
                                        “DevSecOps is a container buzzword. The Academy has created a taxonomy that
                                        helped me
                                        structure my learning and improve coaching of my students and teams”
                                        <strong>
                                            <br />
                                        </strong>
                                    </em>
                                ...
                                <img
                                    src="/img/images/happy-man-wearing-glasses-using-laptop-computer-PXW6K3G.png"
                                    alt=""
                                    className="img-fluid dennis_note"
                                />
                            </div>
                        </div>
                    </div>
