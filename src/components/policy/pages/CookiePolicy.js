        ...
        <div className="content">
            <Typography>
                <div className="policy-card">
                    <Paragraph>
                        DevSecOps Academy B.V. operates the www.devsecops-academy.com and app.devsecops-academy.com website, which provides training services (Service).
                        This page is used to inform website visitors regarding our policies with the collection, use,
                        and
                        disclosure of Personal Information if anyone decided to use our Service, the DevSecOps Academy
                        website.
